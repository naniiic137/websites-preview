...
(function () {
  ...
  const HOMES = [
    ...
    H('appartement-marsa-cube', { img: 'int-living-art', title: 'Appartement Cube', type: 'Apartment', deal: 'buy', city: 'La Marsa', area: 'Marsa Cube', price: 465000, beds: 3, baths: 2, size: 135, year: 2019, rank: 13, agent: 'leila', coast: true, ll: [36.884, 10.33], alt: 'Living room with a white sofa, blue cushions and artwork', extra: ['kitchenWhite', 'bedLight', 'bath'], features: ['Sea glimpse', 'Balcony', 'Lift', 'Parking', 'Air conditioning'], near: [['Beach', '400 m'], ['Marsa Cube shops', '200 m'], ['Int. school', '1.5 km'], ['TGM station', '700 m']], desc: 'A bright three-bedroom apartment above the Marsa Cube shops, with a balcony that catches the sea breeze and a parking space in the basement.' }),
    H('appartement-ennasr-vente', { img: 'int-living-minimal', title: 'Appartement Ennasr 1', type: 'Apartment', deal: 'buy', city: 'Ariana', area: 'Ennasr 1', price: 298000, beds: 2, baths: 1, size: 98, year: 2021, isNew: true, rank: 14, agent: 'sarra', coast: false, ll: [36.857, 10.17], alt: 'Minimalist open-plan living room with wood panelling', extra: ['kitchenWhite', 'bedLight'], features: ['Fitted kitchen', 'Balcony', 'Lift', 'Parking', 'Fibre internet'], near: [['Shops & cafés', '100 m'], ['Metro (Line 2)', '1.1 km'], ['Park', '600 m'], ['School', '400 m']], desc: 'A new two-bedroom apartment with an open-plan living room and fitted kitchen, in a quiet residence of Ennasr 1 close to shops and schools.' }),
    H('maison-carthage', { img: 'int-kitchen-white', title: 'Maison Salammbô', type: 'House', deal: 'buy', city: 'Carthage', area: 'Carthage Salammbô', price: 980000, beds: 4, baths: 3, size: 260, land: 500, year: 2014, rank: 15, agent: 'leila', coast: true, ll: [36.843, 10.32], alt: 'White kitchen with island and pendant lights', extra: ['livingCosy', 'bedDark', 'bath'], features: ['Garden', 'Terrace', 'Garage', 'Fireplace', 'Central heating'], near: [['Beach', '500 m'], ['TGM station', '300 m'], ['Punic ports', '600 m'], ['School', '800 m']], desc: 'A family house in Salammbô, renovated around a large white kitchen that opens onto the garden, with four bedrooms and a garage.' }),
    H('appartement-sousse-location', { img: 'int-living-cosy', title: 'Appartement Khezama', type: 'Apartment', deal: 'rent', city: 'Sousse', area: 'Khezama Est', price: 1600, beds: 2, baths: 1, size: 95, year: 2018, rank: 16, agent: 'youssef', coast: true, ll: [35.852, 10.61], alt: 'Bright living room with beige sofas and large windows', extra: ['kitchenWhite', 'bedLight'], features: ['Furnished', 'Balcony', 'Lift', 'Air conditioning', 'Parking'], near: [['Beach', '700 m'], ['Mall of Sousse', '1.5 km'], ['Clinic', '900 m'], ['Café strip', '200 m']], desc: 'A furnished two-bedroom apartment a short walk from the beach in Khezama, with air conditioning and a covered parking space.' }),
    H('maison-hammamet-location', { img: 'int-bedroom-light', title: 'Maison des Orangers', type: 'House', deal: 'rent', city: 'Hammamet', area: 'Hammamet Nord', price: 4200, beds: 3, baths: 2, size: 180, land: 600, year: 2016, rank: 17, agent: 'youssef', coast: true, ll: [36.42, 10.6], alt: 'Light bedroom with black-framed doors to the garden', extra: ['livingArt', 'kitchenMarble', 'bath'], features: ['Furnished', 'Garden', 'Pool', 'Terrace', 'Parking'], near: [['Beach', '500 m'], ['Hammamet medina', '4 km'], ['Golf', '3 km'], ['Supermarket', '800 m']], desc: 'A single-storey furnished house in an orange grove, with a small pool, three bedrooms opening onto the garden and the beach a short walk away.' }),
    H('penthouse-berges-location', { img: 'int-living-bright', title: 'Penthouse Berges du Lac', type: 'Penthouse', deal: 'rent', city: 'Tunis', area: 'Les Berges du Lac', price: 5500, beds: 3, baths: 3, size: 200, year: 2020, rank: 18, agent: 'karim', coast: false, lake: true, ll: [36.834, 10.24], alt: 'Double-height living room with sofas and a staircase', extra: ['kitchenMarble', 'bedDark', 'bath'], features: ['Furnished', 'Terrace', 'Lake view', 'Air conditioning', '2 parking spaces', '24/7 security'], near: [['Lake promenade', '150 m'], ['Embassies', '600 m'], ['Int. school', '1.8 km'], ['Airport', '5 km']], desc: 'A furnished duplex penthouse with a double-height living room and a terrace over the lake — ideal for executives relocating to Tunis.' })
  ];
  ...
  function renderCompare() {
    ...
    $('#cmpTable').style.setProperty('--n', hs.length);
